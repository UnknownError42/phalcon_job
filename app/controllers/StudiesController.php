...
use Phalcon\Filter;
//use form
use App\Forms\StudiesForm;


class StudiesController extends \Phalcon\Mvc\Controller {

    public function indexAction() {
        $this->view->form = new StudiesForm();
    }
    
    public function backAction() {
        $this->response->redirect('personalData');

    }

    public function addAction() {
        
        $form = new StudiesForm();
